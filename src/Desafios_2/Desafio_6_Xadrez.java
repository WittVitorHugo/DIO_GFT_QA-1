 ...
 * (canto inferior direito) será também branca.
 * Porém, neste problema, queremos ser capazes de predizer a cor independente do
 * número de linhas e colunas, sendo: L linhas e C colunas.
 * No exemplo da figura, para L = 6 e C = 9, a casa no canto inferior direito será preta,
 * uma simples previsão matemática, não?
 */

public class Desafio_6_Xadrez {
